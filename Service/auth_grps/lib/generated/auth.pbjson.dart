...
@$core.Deprecated('Use reqestDtoDescriptor instead')
const ReqestDto$json = {
  '1': 'ReqestDto',
};

/// Descriptor for `ReqestDto`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List reqestDtoDescriptor =
    $convert.base64Decode('CglSZXFlc3REdG8=');
